...
Feature: Launch Activity
  Scenario Outline: Verify Content of learnign objective and introduction 
    ...
    And the activity title and learning objectives should match the content matrix of Activity Six - Learning Mode

    When the user clicks the Start button on the Learning Objectives page of Activity Six - Learning Mode
    Then the Introduction page of Activity Six - Learning Mode should be visible
    And the introduction text should match the content matrix of Activity Six - Learning Mode

    When the user clicks the Continue button on the Introduction page of Activity Six - Learning Mode
    Then the first step of Activity Six - Learning Mode should be displayed
