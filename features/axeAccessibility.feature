...
Feature: Axe Accessibility Scan All Activity
  ...
  Scenario Outline: Run axe Accessibility Automation on all page of [<Activity Number>]
    ...
    And perfome accessibility scan for "<Activity Number>-LearningObjectivePage"
    ...
    And perfome accessibility scan for "<Activity Number>-IntroductionPopup"
    ...
    And perfome accessibility scan for "<Activity Number>-AvatarSelectionPage"
    
    When the user enters a name and clicks the Done button
    Then the Chat section should be displayed
    And perfome accessibility scan for "<Activity Number>-ConversationPage"
    
    When the user click on the Introduction button in more options menue items
    Then perfome accessibility scan for "<Activity Number>-IntroductionPopupMoreOptions"
    ...
    Then perfome accessibility scan for "<Activity Number>-LearningObjectivePopup"
  ...
  Scenario Outline: Run axe Accessibility Automation on all page of [<Activity Number>]
    ...
    And perfome accessibility scan for "<Activity Number>-IntroductionPage"
    ...
    And perfome accessibility scan for "<Activity Number>-FirstStep"
